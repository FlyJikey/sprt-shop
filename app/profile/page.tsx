        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <section className="flex-1">
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 min-h-[500px]">
              <div className="flex items-center gap-2 mb-8 font-black text-gray-900 text-xl uppercase tracking-tighter">
                <ShoppingBag size={24} className="text-blue-600" /> Мои покупки
              </div>
